...
UPDATE syntax_practice SET account_balance = 10.00  WHERE transactions_attempted = 0 AND transactions_completed = 0;
...
('Bruce Wayne', 'Gotham', 5500005, 55500, 3000000000);
